...
De analyse is uitgevoerd in R. Eerst is het humane referentiegenoom GRCh38.p14 (GCF_000001405.40) geïndexeerd met het R-package Rsubread v2.24.0 (Liao et al., 2019). Vervolgens zijn paired-end reads uitgelijnd tegen dit referentiegenoom, waarna voor alle samples BAM-bestanden zijn gegenereerd.
...
Voor visualisatie is een volcano plot gemaakt met EnhancedVolcano v1.28.2 (Blighe et al., 2022). Daarnaast zijn significant differentieel tot expressie komende genen geselecteerd voor functionele verrijkingsanalyses. Gene Ontology (GO)-analyse is uitgevoerd met clusterProfiler v4.18.4 (Wu et al., 2021), waarbij biologische processen, cellulaire componenten en moleculaire functies zijn onderzocht. KEGG pathway-analyse is toegepast om verrijkte signaalroutes te identificeren. De visualisatie van pathways is uitgevoerd met pathview. Ten slotte zijn de differentieel geëxprimeerde genen geprojecteerd op de KEGG Rheumatoid arthritis-pathway (hsa05323) met behulp van pathview versie 1.50.0 (Luo & Brouwer, 2013). Hiermee zijn de veranderingen in genexpressie binnen de context van de RA-gerelateerde pathway gevisualiseerd.
